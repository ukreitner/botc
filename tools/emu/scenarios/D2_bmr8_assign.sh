#!/bin/zsh
# Assign the eight re-test characters to seats 1..8 after D2_bmr8_setup.py.
#
...
assign 1  "Gossip"      "Gossip"
assign 2  "Innkeeper"   "Innkeeper"
assign 3  "Courtier"    "Courtier"
assign 4  "Minstrel"    "Minstrel"
assign 5  "Fool"        "Fool"
assign 6  "Tinker"      "Tinker"
assign 7  "Assassin"    "Assassin"
assign 8  "Zombuul"     "Zombuul"
hide_ime
./ui.py $S find "^Seat "
